...
class ReceivedOrders extends StatelessWidget {
  ReceivedOrders({super.key, required this.orderReceived});
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return InkWell(
          onTap: () {
            Get.to(MyOrderDetilsScreen(orderList: orderReceived[index]));
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        timeago.format(
                            DateTime.parse(orderReceived[index]!.createdAt)),
                        style: CustomTheme.of(context).bodyMedium.override(
                              fontFamily: 'SF Pro Text',
                              color: CustomTheme.of(context).black40,
                              fontSize: 12.0,
