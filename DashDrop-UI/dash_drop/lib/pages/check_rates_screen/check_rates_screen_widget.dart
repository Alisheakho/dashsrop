...
import '/components/check_rates_bottomsheet_widget.dart';
...
import 'check_rates_screen_model.dart';
export 'check_rates_screen_model.dart';

class CheckRatesScreenWidget extends StatefulWidget {
  const CheckRatesScreenWidget({super.key});

  @override
  State<CheckRatesScreenWidget> createState() => _CheckRatesScreenWidgetState();
}

class _CheckRatesScreenWidgetState extends State<CheckRatesScreenWidget> {
  CheckRatesScreenController controller = Get.put(CheckRatesScreenController());
  ...
  void initState() {
    ...
    controller.textFieldFocusNode1!.addListener(() => setState(() {}));
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/check_rate_group.png',
                              width: 24.0,
                              height: 106.0,
                              fit: BoxFit.cover,
                            ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            CustomTheme.of(context).lightGray,
                                        borderRadius:
                        ...
                        return GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: const SizedBox(
                              height: 420.0,
                              child: CheckRatesBottomSheetWidget(),
                            ),
                          ),
                        );
                      },
