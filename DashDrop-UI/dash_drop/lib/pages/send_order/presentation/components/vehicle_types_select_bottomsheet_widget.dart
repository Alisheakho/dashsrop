...
class VehicleTypesSelectBottomsheetWidget extends StatefulWidget {
  const VehicleTypesSelectBottomsheetWidget({super.key});

  @override
  State<VehicleTypesSelectBottomsheetWidget> createState() =>
      _VehicleTypesSelectBottomsheetWidgetState();
}

class _VehicleTypesSelectBottomsheetWidgetState
    extends State<VehicleTypesSelectBottomsheetWidget> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: () async {
                    SendOrderController.to.createOrderModel.value
                        .vehicleDetailSearch?.vehicleType = VehicleTypes.bicyle;
                    Get.back();
                  },
                  child: Container(
                    width: double.infinity,
                ...
                InkWell(
                  ...
                  onTap: () async {
                    SendOrderController.to.createOrderModel.value
                        .vehicleDetailSearch?.vehicleType = VehicleTypes.car;
                    Get.back();
                  },
                  child: Container(
                    width: double.infinity,
                ...
                InkWell(
                  ...
                  onTap: () async {
                    SendOrderController.to.createOrderModel.value
                        .vehicleDetailSearch?.vehicleType = VehicleTypes.van;
                    Get.back();
                  },
                  child: Container(
                    width: double.infinity,
                ...
                InkWell(
                  ...
                  onTap: () async {
                    SendOrderController
                        ...
                        .value
                        .vehicleDetailSearch
                        ?.vehicleType = VehicleTypes.pickTruck;
                    Get.back();
                  },
                  child: Container(
                    width: double.infinity,
                ...
                InkWell(
                  ...
                  onTap: () async {
                    SendOrderController.to.createOrderModel.value
                        .vehicleDetailSearch?.vehicleType = VehicleTypes.truck;
                    Get.back();
                  },
                  child: Container(
                    width: double.infinity,
