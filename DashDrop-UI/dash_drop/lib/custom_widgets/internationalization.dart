...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // HomePage
  {
    ...
    'manualyLacationDessi': {
      'en': 'If this location is not your current location please set it manually',
      'ar': 'إذا كان هذا الموقع ليس موقعك الحالي، فيرجى تعيينه يدويًا',
    },
    'confirmOrderdissi': {
      'en': 'If you press on Receive now the order will be available for drivers',
    ...
    '191amzhi': {
      'en': 'Idlib, Idlib Center',
      'ar': 'إدلب, مركز المدينة',
    },
    '84bm4ojg': {
      'en': 'Shipping to',
      'ar': 'يشحن إلى',
    ...
    'u0babjbv': {
      'en': 'Your order is in ongoing',
      'ar': 'طلبك قيد التنفيذ',
    },
    'tngq47xl': {
      'en': 'Services and Product',
    ...
    'wj0a62d7': {
      'en': ' Your order complete',
      'ar': 'اكتمل طلبك',
    },
    'cghu6ay6': {
      'en': 'No Order yet!',
      'ar': 'لا يوجد أمر حتى الآن!',
    },
    '0rx3n5da': {
    ...
    'ijeanr72': {
      'en': 'Wow, this is really epic',
      'ar': 'واو، هذه ملحمة حقًا',
    },
    'job8dyet': {
      'en': '2',
      'ar': '2',
    ...
    'aai9k93t': {
      'en': 'Sanjuanita Ordonez',
      'ar': 'سانخوانيتا أوردونيز',
    },
    'rilztimj': {
  ...
  // intro_screen
  {
    ...
    '1p2ipkfz': {
      'en': 'Delivery Anywhere',
      'ar': 'التسليم في أي مكان',
    },
    '8d3nia2f': {
  ...
  // order_form_screen
  {
    ...
    'ma84if37': {
      'en': 'Enter your location detail',
      'ar': 'أدخل تفاصيل موقعك',
    },
    'nibbsl9o': {
      'en': 'Please enter a valid full name',
      'ar': 'الرجاء إدخال اسم كامل صالح',
  ...
  // order_detail_screen
  {
    ...
    'registerOrderDisc': {
      'en': 'Your order have been registered successfully, Share this code with who you want to receive the package',
  ...
  // notifications_screen
  {
    ...
    'qzg6kice': {
      'en': 'Credit Card Connected!',
      'ar': 'بطاقة الائتمان متصلة!',
    },
    '1fxat6na': {
  ...
  // quincy_courtdc_dialog
  {
    'j2nqcg6o': {
      'en': 'Quincy Court DC',
      'ar': 'كوينسي كورت دي سي',
    },
    'svshlu5q': {
      'en': '45894 Schneemann Road',
      'ar': '45894 طريق شنيمان',
    },
    '1wjdr2kp': {
      'en': '09:00 AM - 05:00PM',
  ...
  {
    'u411a93c': {
      'en': 'Scan Barcode Success',
      'ar': 'نجاح مسح الباركود',
    },
    '68znnykb': {
  ...
  // nearby_drop_bottomsheet
  {
    ...
    'opo0jnp2': {
      'en': '4589 Superior Road',
      'ar': '4589 طريق سوبيريور',
    },
    '0qn8uj0f': {
      'en': '2.5 KM',
      'ar': '2.5 كم',
    ...
    'c15lyckr': {
      'en': 'Pearson Terrace DC',
      'ar': 'بيرسون تيراس دي سي',
    },
    'g1i7oqrg': {
      'en': '856 Messerschmidt Circle',
      'ar': '856 دائرة مسرشميدت',
    },
    '4ixbr0rk': {
      'en': '5.1 KM',
      'ar': '5.1 كم',
