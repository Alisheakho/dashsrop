...
import '../screens/detielsorder.dart';

class DriverHistoryOrders extends StatelessWidget {
  final List historyorder;
  const DriverHistoryOrders({required this.historyorder});
      ...
      itemBuilder: (context, index) {
        return InkWell(
          onTap: () {
            ...
            Get.to(MyOrderDetilsDriverScreen(orderList: historyorder[index]));
          },
          child: Column(
            children: [
              index == 0
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        timeago.format(
                            DateTime.parse(historyorder[index]!.createdAt)),
