...
class MyOrderDetilsDriverScreen extends StatefulWidget {
  final BoxOrder? orderList;
  const MyOrderDetilsDriverScreen({super.key, this.orderList});
  @override
  State<MyOrderDetilsDriverScreen> createState() => _MyOrderScreenState();
}

class _MyOrderScreenState extends State<MyOrderDetilsDriverScreen> {
                                                    ...
                                                    children: [
                                                      ...
                                                      index == 0
                                                          ...
                                                          : index == 1
                                                              ...
                                                              : index == 2
                                                                  ? Text(
                                                                      '${widget.orderList!.estimatedTime}')
                                                                  : index == 3
                                                                      ? Text(
                                                                          '${widget.orderList!.deliveryCost}')
                                                                      : index ==
                                                                              4
                                                                          ? Text(
                                                                              '${widget.orderList!.vehicleDetail != null ? widget.orderList!.vehicleDetail!['sensitivityLevel'] : const Text('There is no driver')}')
                                                                          : index == 5
