...
class GlobalTheme {
  ...
  // التعديل 1: تغيير النوع المتوقع هنا إلى CardThemeData?
  static ThemeData theme(ColorScheme colorScheme, Color focusColor,
    ...
    return ThemeData(
      ...
      hintColor: hintColor,
      // التعديل 2: تمرير cardTheme كما هو لأنه أصبح من النوع الصحيح
      cardTheme: cardTheme,
    );
  }

  // التعديل 3: استخدام CardThemeData بدلاً من CardTheme
  ...
  // التعديل 4: نفس الشيء للوضع الليلي
  ...
  static const ColorScheme darkColorScheme = ColorScheme(
    ...
    surface: GlobalColors.darkBackgroundColor,
