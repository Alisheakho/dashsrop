        ...
        const Row(
          ...
          children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('Roger Culhane', style: TextStyle(fontSize: 16)),
              SizedBox(
                height: 10,
              ),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('Cristofer Levin', style: TextStyle(fontSize: 16)),
              SizedBox(
                height: 10,
              ),
              Text('userID: contact@example.com',
        ...
        const Row(
          children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('FedEx - Take up to 3', style: TextStyle(fontSize: 16)),
              SizedBox(
                height: 10,
              ),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('Apply Pay Mastercard', style: TextStyle(fontSize: 16)),
              SizedBox(
                height: 10,
              ),
