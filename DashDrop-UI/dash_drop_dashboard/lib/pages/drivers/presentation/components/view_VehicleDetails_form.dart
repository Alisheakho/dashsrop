...
class ViewVehicleDetailsForm extends StatelessWidget {
  const ViewVehicleDetailsForm({required this.vehicleDetails, super.key});
      ...
      child: _titleWidget(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.avgSpeedKm.toString(),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.maxCapacityCubicM.toString(),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.maxRangekm.toString(),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.maxWeightKg.toString(),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.profitPerKm.toString(),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: SensitivityLevels
                  .values[vehicleDetails.sensitivityLevel]
                  .toString()
                  .replaceAll('SensitivityLevels.', ''),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: VehicleTypes.values[vehicleDetails.type]
                  .toString()
                  .replaceAll('VehicleTypes.', ''),
              labelText: lang.sensitivityLevel,
              hintText: lang.sensitivityLevel,
            ),
            const SizedBox(
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.specifications.toString(),
            ...
            OutBorderTextFormField(
              readOnly: true,
              initialValue: vehicleDetails.createdAt.toString(),
