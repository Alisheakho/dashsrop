...
class CreateDriverForm extends StatelessWidget {
  CreateDriverForm({super.key});
          ...
          Form(
            ...
            child:
              ...
              OutBorderTextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    Tost().warning(context, "Please enter password");
                    isValidate = false;
                    return;
              ...
              OutBorderTextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    Tost().warning(context, "Please retype password");
                    isValidate = false;
                    return;
              ...
              BlocConsumer<DriverBloc, DriverState>(
                builder: (context, state) {
                  ...
                  List<String> regions =
                      state.getRegions.map((e) => e.name).toList();
                  List<String> vehicleDetails = state.getVehicleDetails
                      .map((e) => e.id.toString())
                      .toList();
                ...
                listener: (context, state) {
                  if (state.updateDriverstate == RequestState.loaded) {
                    ...
                    if (state.updateDriversErrors != null) {
                      state.updateDriversErrors?.forEach((name, info) =>
                          Tost().warning(context, "$name : $info"));
                    }
                  }
                },
              ),
