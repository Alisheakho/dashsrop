...
import 'package:dashdrop_uikit/components/badge/anim_badge.dart';
import 'package:dashdrop_uikit/components/buttons/button_widget.dart';
import 'package:dashdrop_uikit/components/forms/search_widget.dart';
            ...
            children: [
              Container(
                  ...
                  decoration: const BoxDecoration(
                      color: DashDropColors.background, shape: BoxShape.circle),
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      child: Container(
          ...
          decoration: BoxDecoration(
              color: DashDropColors.background,
            ...
            children: [
              CircleAvatar(
                ...
                child: SvgPicture.asset('assets/toolbar/sun.svg',
                    ...
                    height: 18,
                    color: isDark
                        ? DashDropColors.darkTextBody
                        : DashDropColors.primary),
              ),
              CircleAvatar(
                radius: 15,
